...
keymap.set("n", "<D-1>", function() harpoon:list():select(1) end)
keymap.set("n", "<D-2>", function() harpoon:list():select(2) end)
keymap.set("n", "<D-3>", function() harpoon:list():select(3) end)
keymap.set("n", "<D-4>", function() harpoon:list():select(4) end)
